...
class Ui_aboutDialog(object):
    def setupUi(self, aboutDialog):
        ...
        self.line.setGeometry(QtCore.QRect(140, 190, 321, 20))
        ...
        self.bgArtLabel.setPixmap(QtGui.QPixmap(":/icons/efpm_dialog.png"))
